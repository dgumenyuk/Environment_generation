...
class BeamngExecutor(AbstractTestExecutor):
    ...
    def __init__(self, map_size, result_folder="./", time_budget=500, 
                 oob_tolerance=0.95, max_speed=70,
                 beamng_home="C:\\Users\\gumen\\Downloads\\BeamNG.research.v1.7.0.1\\", beamng_user=None, road_visualizer=None):
    ...
    def _eval_tc(self, the_test) -> SimulationData:
            if not self.brewer:
            ...
            try:
                ...
                while True:
                    ...
                    oob_list.append(last_state.oob_percentage)
                    dist_list.append(last_state.oob_distance)
            ...
            if (oob_list and dist_list):
                return max(oob_list), max(dist_list)
            else:
                return 0, 0
