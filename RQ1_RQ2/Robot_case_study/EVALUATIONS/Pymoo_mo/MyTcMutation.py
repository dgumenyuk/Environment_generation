        ...
        for i in range(len(X)):
            ...
            if r < self.mut_rate:#cf.ga["mut_rate"]:
                ...
                if wr < 0.2:
                    ...
                    if value == "value":
                        duration_list = [i for i in range(cf.model["min_len"], cf.model["max_len"] + 1, cf.model["len_step"])] 
                        ...
                        duration_list = [i for i in range(cf.model["min_len"], cf.model["map_size"] - cf.model["min_len"], cf.model["pos_step"])] 
                        child["st" + str(num)]["value"] = int(np.random.choice(duration_list))
                else:
