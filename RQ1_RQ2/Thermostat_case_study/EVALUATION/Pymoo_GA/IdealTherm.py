'''
Module to translate the test scenario to the environment for the model (a scheduled temperature list).
It is also used to calculate the output of the model in the generated environment
